...
from apps.account.repositories import account_repository, account_products_repository
...
class TestAccountRepositories(TestCase):
    ...
    def test_get_account_by_id(self):
        self.assertEqual(account_repository.get_account_by_id(self.account.id), self.account)
...
class TestAccountProductsRepositories(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.account_product = AccountProducts.objects.create(account=cls.account, product=cls.product)
    
    def test_get_account_products(self):
        account_products = account_products_repository.get_account_products(self.account.id)
